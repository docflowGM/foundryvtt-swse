...
| Martial Arts I | fully_implemented | Normalized as a passive weapon/defense rule: +1 unarmed damage die step, +1 dodge bonus to Reflex Defense, and unarmed attacks do not provoke attacks of opportunity. Runtime exposes Martial Arts level/count and the armed-unarmed flag for breakdown consumers. |
| Martial Arts II | fully_implemented | Normalized as its own stacking passive rule: +1 unarmed damage die step and +1 dodge bonus to Reflex Defense. It stacks with Martial Arts I rather than replacing it. |
| Martial Arts III | fully_implemented | Normalized as its own stacking passive rule: +1 unarmed damage die step and +1 dodge bonus to Reflex Defense. It stacks with Martial Arts I and II rather than replacing them. |
