...
| Martial Arts I | fully_implemented | Normalized as passive rules consumed by the automatic virtual Unarmed Strike. The virtual unarmed attack mutates its displayed/rolled damage by +1 unarmed die step and flips its opportunity-attack metadata so it does not provoke. Martial Arts I also contributes +1 stacking dodge to Reflex Defense. |
| Martial Arts II | fully_implemented | Normalized as its own stacking passive rule consumed by the automatic virtual Unarmed Strike: +1 additional unarmed damage die step and +1 stacking dodge bonus to Reflex Defense. |
| Martial Arts III | fully_implemented | Normalized as its own stacking passive rule consumed by the automatic virtual Unarmed Strike: +1 additional unarmed damage die step and +1 stacking dodge bonus to Reflex Defense. |
