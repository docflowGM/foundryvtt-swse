...
| skills.ability | system.skills.{key}.selectedAbility | (part of derived) | Template | Template | system.skills.{key}.selectedAbility | No | (none) | Governing ability for the skill (canonical path in code) |
