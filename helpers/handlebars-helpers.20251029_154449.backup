 ...
 * Registers custom module/helpers for use in system templates.
 */
...
export function registerHandlebarsHelpers() {
  ...
  // ---- Boolean/checkbox module/helpers ----
...
// Auto-register module/helpers on load
