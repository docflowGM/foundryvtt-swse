// scripts/engines/shared/xp-system.js
//
// Pure XP computation utilities — shared across all engines.
// No external dependencies. No side effects.
// Used by: ActorEngine (governance), xp-engine (progression), and utilities.
