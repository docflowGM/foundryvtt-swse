...
/**
 * Handle bottom tabs navigation (Equipment / Feats / Talents / Powers / Notes)
 */
 ...
 */
export function initializeAddEquipment(html, actor) {
  html.find('.add-equipment-btn').on('click', async (event) => {
    ...
    ui.notifications.info("Add Equipment functionality - implement item browser/compendium");
  });
}
...
export function activateSheetListeners(html, sheet) {
  ...
  initializeAddEquipment(html, actor);
