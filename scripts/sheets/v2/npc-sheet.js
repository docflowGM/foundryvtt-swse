 ...
 */
export class SWSEV2NpcSheet extends foundry.applications.sheets.ActorSheetV2 {
  ...
  async _prepareContext(options) {
    ...
    console.log(`📦 SWSEV2NpcSheet _prepareContext CALLED for ${this.document.name}`);
  ...
  async _onRender(context, options) {
    console.log(`🖼️ SWSEV2NpcSheet _onRender CALLED for ${this.document.name}`, { hasElement: !!this.element, childCount: this.element?.children?.length });
