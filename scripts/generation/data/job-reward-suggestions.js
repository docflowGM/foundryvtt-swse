...
export const JOB_REWARD_SUGGESTIONS = Object.freeze([
  ...
  { value: 'a modest favor, smaller than the crew was clearly hoping for', weight: 1, tags: [], type: 'favor' },
  ...
  { value: 'forgiveness of a debt that was about to be sold off to a collections agency', weight: 1, tags: [], type: 'debtForgiveness' },
  { value: 'salvage rights the employer\'s own crew would normally fight to keep', weight: 1, tags: [], type: 'salvageRights' },
  { value: 'a favor the employer\'s organization will honor even after the employer is gone', weight: 1, tags: [], type: 'favor' },
