...
import { HooksRegistry } from "/scripts/infrastructure/hooks/hooks-registry.js";
import { SWSELogger } from "/scripts/utils/logger.js";
import { initializeStarshipManeuverHooks } from "/scripts/infrastructure/hooks/starship-maneuver-hooks.js";
import { initializeForcePowerHooks } from "/scripts/infrastructure/hooks/force-power-hooks.js";
import { StarshipDomainLifecycle } from "/scripts/infrastructure/hooks/starship-domain-lifecycle.js";
import { ForceDomainLifecycle } from "/scripts/infrastructure/hooks/force-domain-lifecycle.js";
import { registerTelekineticProdigyHook } from "/scripts/engine/progression/engine/telekinetic-prodigy-hook.js";
import { qs, qsa, setVisible, isVisible, text } from "/scripts/utils/dom-utils.js";
        ...
        buttons: {
            select: {
                ...
                callback: async (html) => {
                    ...
                    await globalThis.SWSE.ActorEngine.updateEmbeddedDocuments(actor, 'Item', [{ _id: item.id, 'system.description': updatedDescription }]);
