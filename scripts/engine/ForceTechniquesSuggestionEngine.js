/**
 * SWSE Force Technique Suggestion Engine
 *
...
export class ForceTechiquesSuggestionEngine {
  /**
   ...
   * @param {Object} characterData - Pending character data (for levelup)
   * @param {Object} options - Additional options
   * @returns {Promise<Array>} Sorted array of suggestions with scores
   */
  static async suggestForceOptions(availableTechniques = [], actor = null, characterData = {}, options = {}) {
...
export default ForceTechiquesSuggestionEngine;
