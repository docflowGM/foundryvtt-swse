...
export function normalizeVehicleImportData(system, options = {}) {
  ...
  try {
    ...
    normalized.vehicleHasHyperdrive = Boolean(system.vehicleHasHyperdrive ?? normalized.hyperdrive_class);
    normalized.vehicleHasBackupHyperdrive = Boolean(system.vehicleHasBackupHyperdrive ?? normalized.backup_class);
    normalized.vehicleHyperdriveClass = system.vehicleHyperdriveClass ?? null;
    normalized.vehicleBackupHyperdriveClass = system.vehicleBackupHyperdriveClass ?? null;
    normalized.vehicleHyperdriveClassLabel = safeString(system.vehicleHyperdriveClassLabel, '');
    normalized.vehicleBackupHyperdriveClassLabel = safeString(system.vehicleBackupHyperdriveClassLabel, '');
    normalized.vehicleHyperdriveTier = safeString(system.vehicleHyperdriveTier, '');
    normalized.vehicleBackupHyperdriveTier = safeString(system.vehicleBackupHyperdriveTier, '');
    normalized.vehicleHyperdriveLabel = safeString(system.vehicleHyperdriveLabel, normalized.hyperdrive_class || '');
    normalized.vehicleHyperdriveDataStatus = safeString(system.vehicleHyperdriveDataStatus, '');
    normalized.vehicleAstrogationSupportStatus = safeString(system.vehicleAstrogationSupportStatus, '');
    normalized.vehicleAstrogationSupportLabel = safeString(system.vehicleAstrogationSupportLabel, '');
    normalized.vehicleHasNavicomputer = system.vehicleHasNavicomputer ?? null;
    normalized.vehicleHasAdvancedNavicomputer = system.vehicleHasAdvancedNavicomputer ?? null;
    normalized.vehicleRequiresAstromechForAstrogation = system.vehicleRequiresAstromechForAstrogation ?? null;
    normalized.vehicleNavigationNotes = safeString(system.vehicleNavigationNotes, '');
    normalized.vehicleConsumablesDays = system.vehicleConsumablesDays ?? null;
    normalized.vehicleConsumablesLabel = safeString(system.vehicleConsumablesLabel, normalized.consumables);
    normalized.vehicleConsumablesGroup = safeString(system.vehicleConsumablesGroup, '');
    normalized.vehicleConsumablesGroupLabel = safeString(system.vehicleConsumablesGroupLabel, '');
    normalized.vehicleConsumablesDataStatus = safeString(system.vehicleConsumablesDataStatus, '');
    normalized.vehicleCarriedCraftRaw = safeString(system.vehicleCarriedCraftRaw, '');
    normalized.vehicleHasCarriedCraft = Boolean(system.vehicleHasCarriedCraft);
    normalized.vehicleCarriedCraftLabel = safeString(system.vehicleCarriedCraftLabel, normalized.carried_craft || 'None listed');
    normalized.vehicleCarriedCraftDataStatus = safeString(system.vehicleCarriedCraftDataStatus, '');
    normalized.vehiclePayloadRaw = safeString(system.vehiclePayloadRaw, '');
    normalized.vehicleHasPayload = Boolean(system.vehicleHasPayload);
    normalized.vehiclePayloadLabel = safeString(system.vehiclePayloadLabel, system.payload || 'None listed');
    normalized.vehiclePayloadDataStatus = safeString(system.vehiclePayloadDataStatus, '');
    normalized.vehicleEmplacementPoints = system.vehicleEmplacementPoints ?? null;
    normalized.vehicleUnusedEmplacementPoints = system.vehicleUnusedEmplacementPoints ?? null;
    normalized.vehicleHasEmplacementPoints = Boolean(system.vehicleHasEmplacementPoints);
    normalized.vehicleEmplacementPointLabel = safeString(system.vehicleEmplacementPointLabel, '');
    normalized.vehicleEmplacementPointDataStatus = safeString(system.vehicleEmplacementPointDataStatus, '');
