...
export const UPGRADE_CATALOG = Object.fromEntries([
  ...
  // Tech Specialist modifications (9 automatable + 4 rule-notes)
  ...
  // Vehicle traits (2 automatable)
  def('tech_improved_shields', { name: 'Improved Shields', category: 'tech-specialist', cost: 0, costFormula: 'max(10% of item cost, 1000 credits)', slotCost: 0, restriction: 'common', source: 'tech-specialist', appliesTo: ['vehicle'], affectedAreas: [], mechanicsDC: 20, timeHours: null, description: 'The vehicle\'s shield rating increases by 5.', metadata: { trait: 'improved_shields', systemPath: 'system.shields.rating', value: 5 } }),
  def('tech_improved_speed', { name: 'Improved Speed', category: 'tech-specialist', cost: 0, costFormula: 'max(10% of item cost, 1000 credits)', slotCost: 0, restriction: 'common', source: 'tech-specialist', appliesTo: ['vehicle'], affectedAreas: [], mechanicsDC: 20, timeHours: null, description: 'The vehicle\'s speed increases by 25% (minimum +1 square).', metadata: { trait: 'improved_speed', systemPath: 'system.speed.base', scaling: 'percent', value: 0.25, minimum: 1 } }),

  // Droid/Character traits (2 automatable)
  def('tech_enhanced_dexterity', { name: 'Enhanced Dexterity', category: 'tech-specialist', cost: 0, costFormula: 'max(10% of item cost, 1000 credits)', slotCost: 0, restriction: 'common', source: 'tech-specialist', appliesTo: ['droid', 'character'], affectedAreas: [], mechanicsDC: 20, timeHours: null, description: 'The droid\'s Dexterity ability score increases by 2.', metadata: { trait: 'enhanced_dexterity', systemPath: 'system.abilities.dexterity.value', value: 2 } }),
  def('tech_enhanced_intelligence', { name: 'Enhanced Intelligence', category: 'tech-specialist', cost: 0, costFormula: 'max(10% of item cost, 1000 credits)', slotCost: 0, restriction: 'common', source: 'tech-specialist', appliesTo: ['droid'], affectedAreas: [], mechanicsDC: 20, timeHours: null, description: 'The droid\'s Intelligence ability score increases by 2.', metadata: { trait: 'enhanced_intelligence', systemPath: 'system.abilities.intelligence.value', value: 2 } }),
  def('tech_enhanced_strength', { name: 'Enhanced Strength', category: 'tech-specialist', cost: 0, costFormula: 'max(10% of item cost, 1000 credits)', slotCost: 0, restriction: 'common', source: 'tech-specialist', appliesTo: ['droid', 'character', 'gear'], affectedAreas: [], mechanicsDC: 20, timeHours: null, description: 'The droid\'s or device\'s Strength ability score increases by 2.', metadata: { trait: 'enhanced_strength', systemPath: 'system.abilities.strength.value', value: 2 } }),

  // Device traits (1 rule-note)
