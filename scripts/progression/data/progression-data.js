...
export const PROGRESSION_RULES = {
  ...
  // REMOVED: Hardcoded class data
  // All class data now loaded from compendium (packs/classes.db) as single source of truth
  // Use getClassData() from class-data-loader.js to access class information
  classes: {},
  templates: {
    "gunslinger_outlaw": {
