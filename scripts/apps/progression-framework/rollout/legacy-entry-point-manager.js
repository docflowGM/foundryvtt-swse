...
export class LegacyEntryPointManager {
  ...
  static LEGACY_ENTRY_POINTS = {
    ...
    'swse-levelup-shim': {
      label: 'SWSELevelUp Compatibility Shim',
      path: 'scripts/apps/swse-levelup.js',
      type: 'levelup',
      status: 'deprecated',
      replacedBy: 'ProgressionShell via launchProgression()',
      deprecatedSince: '1.0.0',
      retireDate: null,
      showWarning: true,
    },
    'swse-levelup-enhanced-shim': {
      label: 'SWSELevelUpEnhanced Compatibility Shim',
      path: 'scripts/apps/swse-levelup-enhanced.js',
      type: 'levelup',
      status: 'deprecated',
      replacedBy: 'ProgressionShell via launchProgression()',
      deprecatedSince: '1.0.0',
    ...
    'chargen-barrel': {
      label: 'Chargen Barrel Export',
      path: 'scripts/apps/chargen.js',
      type: 'chargen',
      status: 'deprecated',
      replacedBy: 'ProgressionShell via launchProgression()',
      deprecatedSince: '1.0.0',
