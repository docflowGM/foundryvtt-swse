/************************************************************
 *  SWSE STORE — SHARED UTILITIES (Bulletproof Edition)
 *  --------------------------------------------------------
 *  This file provides:
 *   - Safe numeric parsing
 *   - Safe text fallback
 *   - Safe image fallback
 *   - Safe item normalization for DB entries
 *   - Rendarr dialogue system
 ************************************************************/
...
export function safeNumber(value) {
    ...
    // Handle strings like "Varies", "—", "Included", "N/A", "Special"
...
/**
 * Normalize cost values specifically.
 */
export function safeCost(value) {
 ...
 */
export function safeWeight(value) {
    const num = safeNumber(value);
    return num >= 0 ? num : 0;
}
...
/**
 * Provide a guaranteed image path.
 */
export function safeImage(src) {
    if (!src || typeof src !== "string" || src.trim() === "")
        return "icons/svg/mystery-man.svg"; // fallback icon
    return src;
}
...
/**
 * Normalize any compendium item so the shop
...
export function normalizeItem(item) {
    ...
    return {
        ...
        system: {
            ...
            cost: safeCost(system.cost),
            weight: safeWeight(system.weight),
            description: safeString(system.description, ""),
            rarity: safeString(system.rarity, ""),
            manufacturer: safeString(system.manufacturer, ""),
            model: safeString(system.model, "")
        }
    };
}
...
/**
 * Normalize a whole list of items.
 */
export function normalizeList(items = []) {
    return items.map(i => normalizeItem(i));
}
 ...
 *  RENDARR DIALOGUE SYSTEM
 * ---------------------------------------------------------
 *  This is your original full dialogue system, preserved
 *  exactly as provided, only wrapped in a clean export.
 * --------------------------------------------------------- */
    ...
    return {
        ...
        medical: [
           "Wise investment! Can't enjoy your purchases if you're dead!", 
            ...
            "Have you seen a rat that goes by Neeko? He missed our last business call recently."
        ],
        tech: [
           "Ah, a tech enthusiast! I've got gadgets that'll make your life easier!", 
            ...
            "I've got more processing power here than a Star Destroyer!"
        ],
        tools: [
            ...
            "For when you need to Imrprovise your way out of trouble!", 
            ...
            "These tools have repaired more ships than there are stars!", 
            ...
            "I've seen miracles performed with tools like these!", 
        ...
        survival: [
            ...
            "For when the elements are trying to kill you!", 
            "Quality survival equipment! Don't leave civilization without it!", 
            "These'll make you self-sufficient enough to live in a cave on Dagobah!", 
            "Smart purchase! Nature doesn't negotiate!", 
            "I love selling these! Means people are planning to come back!", 
            "Survival gear! Because sometimes the mission goes sideways!"
        ],
        security: [
        ...
        droids: [
            ...
            "I got gold droids, blue droids, droids that are tall, droids that are short...", 
            ...
            "These mechanical marvels will never let you down! Unless you forget to plug them in...", 
            "Ah, building your crew! Droids make excellent team members!", 
            "I've sold droids to everyone from jawas to senators!", 
        ...
        vehicles: [
           "Vehicles! For when walking just won't cut it!", 
            ...
            "Quality rides! Some new, some used, but no lemons!", 
        ...
        cart: [
            "Ah, reviewing your selections! Take your time, But don't take all day!", 
        ...
        purchase: [ "Excellent choice! You won't regret it!", 
        ...
        welcome: [ "Welcome to my shop, lad! Spend to your heart's desire!", 
