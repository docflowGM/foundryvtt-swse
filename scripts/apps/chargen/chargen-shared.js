...
export function _getDefaultSkills() {
  ...
  const base = [
    ...(!athleticsOn ? [{ key: 'acrobatics', name: 'Acrobatics', ability: 'dex', trained: false }] : []),
    ...(!athleticsOn ? [{ key: 'climb', name: 'Climb', ability: 'str', trained: false }] : []),
    ...
    ...(!athleticsOn ? [{ key: 'jump', name: 'Jump', ability: 'str', trained: false }] : []),
    ...(athleticsOn ? [{ key: 'athletics', name: 'Athletics', ability: 'dex', trained: false }] : []),
    ...
    ...(!athleticsOn ? [{ key: 'swim', name: 'Swim', ability: 'str', trained: false }] : []),
