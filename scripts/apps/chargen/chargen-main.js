...
import { getTalentTreeName, getClassProperty, getTalentTrees, getHitDie } from "../../apps/chargen/chargen-property-accessor.js";
...
import { MENTORS } from "../../engine/mentor/mentor-dialogues.js";
import { getMentorMemory, setMentorMemory, setTargetClass } from "../../engine/mentor/mentor-memory.js";
...
import { TalentSlotMigrator } from "../../engine/progression/talents/slot-migrator.js";

// Phase 1.5: Feat Slot System
import { FeatSlotValidator } from "../../engine/progression/feats/feat-slot-validator.js";
...
import * as SharedModule from "../../apps/chargen/chargen-shared.js";
import { ChargenDataCache } from "../../apps/chargen/chargen-shared.js";
import * as DroidModule from "../../apps/chargen/chargen-droid.js";
import { ChargenDevGuards, initializeChargenDevGuards } from "../../apps/chargen/chargen-dev-guards.js";
import { ChargenFinalizer } from "../../apps/chargen/chargen-finalizer.js";
import * as SpeciesModule from "../../apps/chargen/chargen-species.js";
import { _filterSpecies, _sortSpeciesBySource } from "../../apps/chargen/chargen-species.js";
import * as BackgroundsModule from "../../apps/chargen/chargen-backgrounds.js";
import * as ClassModule from "../../apps/chargen/chargen-class.js";
import * as AbilitiesModule from "../../apps/chargen/chargen-abilities.js";
import * as SkillsModule from "../../apps/chargen/chargen-skills.js";
import * as LanguagesModule from "../../apps/chargen/chargen-languages.js";
import * as FeatsTalentsModule from "../../apps/chargen/chargen-feats-talents.js";
import * as ForcePowersModule from "../../apps/chargen/chargen-force-powers.js";
import * as StarshipManeuversModule from "../../apps/chargen/chargen-starship-maneuvers.js";
import { renderTalentTreeGraph, getTalentsInTree } from "../../apps/chargen/chargen-talent-tree-graph.js";

import { applyProgressionPatch } from "../../engine/progression/engine/apply-progression-patch.js";
import { buildNamePatch } from "../../apps/chargen/steps/name-step.js";
    ...
    if ((this.currentStep === 'feats' || this.currentStep === 'talents') && context.packs) {
      ...
      if (this.currentStep === 'feats' && context.packs.feats) {
        try {
          ...
          context.packs.feats = AbilityEngine.filterQualifiedFeats(context.packs.feats, tempActor, pendingDataForFeats).map(feat => ({
            ...feat,
            prereqReasons: feat.prerequisiteReasons
          }));
      ...
      if (this.currentStep === 'talents' && context.packs.talents) {
        try {
          ...
          context.packs.talents = AbilityEngine.filterQualifiedTalents(context.packs.talents, tempActor, pendingDataForTalents).map(talent => ({
            ...talent,
