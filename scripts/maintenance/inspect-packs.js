...
async function main() {
  ...
  const packsToInspect = [
    ...
    { name: 'vehicles-speeders', path: 'packs/vehicles-speeders.db', declaredType: 'Actor' },
    { name: 'vehicles-airspeeders', path: 'packs/vehicles-airspeeders.db', declaredType: 'Actor' },
    { name: 'vehicles-tracked', path: 'packs/vehicles-tracked.db', declaredType: 'Actor' },
    { name: 'vehicles-walkers', path: 'packs/vehicles-walkers.db', declaredType: 'Actor' },
    { name: 'vehicles-wheeled', path: 'packs/vehicles-wheeled.db', declaredType: 'Actor' },
    { name: 'vehicles-weapon-emplacements', path: 'packs/vehicles-weapon-emplacements.db', declaredType: 'Actor' },
    { name: 'vehicles-starfighters', path: 'packs/vehicles-starfighters.db', declaredType: 'Actor' },
    { name: 'vehicles-space-transports', path: 'packs/vehicles-space-transports.db', declaredType: 'Actor' },
    { name: 'vehicles-capital-ships', path: 'packs/vehicles-capital-ships.db', declaredType: 'Actor' },
    { name: 'vehicles-stations', path: 'packs/vehicles-stations.db', declaredType: 'Actor' },
    { name: 'vehicles', path: 'packs/vehicles.db', declaredType: 'Actor' },
