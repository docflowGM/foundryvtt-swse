/**
 * Species Trait Types and Constants
 * Defines all canonical trait types for the Species Trait Engine
 */

/**
 * Canonical species trait types
 * These cover ~95% of all SWSE species abilities
 */
export const SPECIES_TRAIT_TYPES = Object.freeze({
  ...
  ENVIRONMENTAL: 'environmentalAdaptation', // Breathe water, cold adaptation
...
/**
 * Valid targets for bonus/penalty traits
 */
...
/**
 * Skill key to display name mapping
 */
