...
SWSE.itemTypes = ['armor', 'attribute', 'background', 'class', 'combat-action', 'condition', 'equipment', 'extra-skill-use', 'feat', 'force-power', 'force-technique', 'force-secret', 'language', 'maneuver', 'poison', 'skill', 'species', 'talent', 'talenttree', 'vehicleWeapon', 'vehicleWeaponRange', 'weaponUpgrade', 'specialCondition', 'weapon'];
