...
export class VehiclePackDataLoader {
  ...
  static async loadVehicleIndex() {
    ...
    for (const name of VEHICLE_PACK_NAMES) {
      ...
      const index = await pack.getIndex({ fields: ['name', 'img', 'system.category', 'system.type', 'system.size', 'system.crew', 'system.cargo', 'system.hyperdrive_class', 'system.hyperdrive', 'system.shields', 'system.shieldRating', 'system.challengeLevel', 'system.cost'] });
