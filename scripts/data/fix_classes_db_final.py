...
# Based on user-provided specs (Ref/Fort/Will format)
PRESTIGE_FIXES: Dict[str, Tuple[int, int, int, int]] = {
    "Ace Pilot":            (8,  4, 2, 0),
    "Bounty Hunter":        (10, 4, 2, 0),
    "Crime Lord":           (8,  2, 0, 4),
    "Elite Trooper":        (12, 2, 4, 0),
    "Force Adept":          (8,  2, 2, 4),
    "Force Disciple":       (8,  3, 3, 6),
    "Gunslinger":           (8,  4, 0, 2),
    "Jedi Knight":          (10, 2, 2, 2),
    "Jedi Master":          (10, 3, 3, 3),
    "Officer":              (8,  2, 0, 4),
    "Sith Apprentice":      (10, 2, 2, 2),
    "Sith Lord":            (10, 3, 3, 3),
    "Corporate Agent":      (8,  2, 0, 4),
    "Gladiator":            (10, 4, 2, 0),
    "Melee Duelist":        (8,  4, 0, 2),
    "Enforcer":             (8,  4, 0, 2),
    "Independent Droid":    (12, 2, 0, 4),
    "Infiltrator":          (8,  4, 0, 2),
    "Master Privateer":     (10, 2, 0, 4),
    "Medic":                (8,  0, 4, 2),
    "Saboteur":             (8,  2, 0, 4),
    "Assassin":             (10, 4, 2, 0),
    "Charlatan":            (8,  2, 0, 4),
