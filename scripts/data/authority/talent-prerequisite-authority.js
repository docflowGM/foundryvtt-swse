...
export const TALENT_PREREQUISITE_AUTHORITY = {
  ...
  "instrument_of_the_force": {
    ...
    "description": "You are particularly in tune with The Living Force. When you successfully use Search Your Feelings, you gain a Force Point that must be used before the end of the encounter.\n\nIf you use this Force Point in a manner that would end in unfavorable results (per Search Your Feelings), you raise your Dark Side Score by 1. If you use the Force Point in an action that would normally raise your Dark Side Score, you raise your Dark Side Score by 2 instead."
  },
  "long_call": {
    "name": "Long Call",
  ...
  "sith_alchemy_specialist": {
    ...
    "prerequisite": "Sith Alchemy",
    "benefit": "You can modify an object with Sith Alchemy so that it gains a specific trait. Specific traits are listed in the Sith Alchemy Table, below. You can only perform one modification at a time. Unless otherwise noted, you cannot grant more than one benefit to a single object, and you cannot apply the same benefit more than once. You must spend a Force Point and devote 1 hour of uninterrupted work to apply a trait to the relevant object, and when you do so, you increase your Dark Side Score by 1.\n\nSith Alchemy Traits:\n\nDark Armor Trait - Cortosis Weave: Automatically deactivates any Lightsaber that strikes the wearer.\n\nDark Armor Trait - Dark Side Energy: Grants the wearer a +2 Equipment bonus on Use the Force checks made to activate Force Powers with the [Dark Side] descriptor.\n\nDark Armor Trait - Dark Side Stealth: Grants the wearer a +2 Equipment bonus on Use the Force checks made to avoid detection.\n\nDark Armor Trait - Imposing Form: Grants the wearer a +2 Equipment bonus on Persuasion checks made to Intimidate.\n\nSith Weapon Trait - Jagged Weapon: Any time the Sith Weapon damages a living creature, that creature takes 1d4 points of damage at the start of its next turn.\n\nSith Weapon Trait - Master's Weapon: The Sith Weapon grants a +2 Equipment bonus on Use the Force checks to use the Block and Deflect Talents.\n\nSith Weapon Trait - Vile Weapon: The Sith Weapon is always considered to be laced with Sith Poison.\n\nSith Abomination Trait - Damage Reduction: The Sith Abomination gains Damage Reduction 5, or increases its existing DR by +5.\n\nSith Abomination Trait - Iron Will: The Sith Abomination gains a +2 Equipment bonus to its Will Defense.\n\nSith Abomination Trait - Vile Natural Weapons: The Sith Abomination's Natural Weapons are laced with Sith Poison.",
  ...
  "dull_the_pain": {"name": "Dull the Pain", "prerequisite": "Medical Droid", "benefit": "As a Full-Round Action, you can make a DC 15 Treat Injury check on an adjacent living creature to move it +1 step along the Condition Track.", "description": "As a Full-Round Action, you can make a DC 15 Treat Injury check on an adjacent living creature to move it +1 step along the Condition Track."},
  "interrogator": {"name": "Interrogator", "prerequisite": "", "benefit": "You can create an aura of unliving, emotionless menace that no biological creature can match, and combine it with the cruel application of medical knowledge. You can use your Treat Injury modifier on a Persuasion check made to change a creature's Attitude, or to Intimidate. You must be adjacent to your target to use this ability, in addition to the normal requirements for these uses of the Persuasion skill.", "description": "You can create an aura of unliving, emotionless menace that no biological creature can match, and combine it with the cruel application of medical knowledge. You can use your Treat Injury modifier on a Persuasion check made to change a creature's Attitude, or to Intimidate. You must be adjacent to your target to use this ability, in addition to the normal requirements for these uses of the Persuasion skill."},
  "medical_droid": {"name": "Medical Droid", "prerequisite": "", "benefit": "When you use a Medpac to perform First Aid with the Treat Injury skill, the creature gains 2 Hit Points for every point by which your check exceeds the DC, rather than the normal 1 Hit Point.", "description": "When you use a Medpac to perform First Aid with the Treat Injury skill, the creature gains 2 Hit Points for every point by which your check exceeds the DC, rather than the normal 1 Hit Point."},
  "known_vulnerability": {"name": "Known Vulnerability", "prerequisite": "Trained in Knowledge (Life Sciences)", "benefit": "You know the vulnerable spots to hit on most species. As a Free Action, you make a DC 15 Knowledge (Life Sciences) check (DC 25 for rare species, DC 35 for unknown species, both as determined by the Gamemaster). If the check is successful, until the end of the encounter, whenever you make a successful melee or unarmed attack that deals damage against a target of that species, your target takes a -2 penalty to attack rolls until the end of your next turn.", "description": "You know the vulnerable spots to hit on most species. As a Free Action, you make a DC 15 Knowledge (Life Sciences) check (DC 25 for rare species, DC 35 for unknown species, both as determined by the Gamemaster). If the check is successful, until the end of the encounter, whenever you make a successful melee or unarmed attack that deals damage against a target of that species, your target takes a -2 penalty to attack rolls until the end of your next turn."},
  "medical_analyzer": {"name": "Medical Analyzer", "prerequisite": "Medical Droid, Trained in Knowledge (Life Sciences)", "benefit": "You use your medical knowledge and advanced droid processor to improve your treatment of medical conditions. When making a Treat Injury check to Treat Disease, Treat Poison, or Treat Radiation, you can also add your Intelligence modifier to your roll.", "description": "You use your medical knowledge and advanced droid processor to improve your treatment of medical conditions. When making a Treat Injury check to Treat Disease, Treat Poison, or Treat Radiation, you can also add your Intelligence modifier to your roll."},
  "science_analyzer": {"name": "Science Analyzer", "prerequisite": "Trained in Knowledge (Life Sciences) and Knowledge (Physical Sciences)", "benefit": "You use your extensive databanks to better analyze scientific data. You can add double your Intelligence modifier to your Knowledge (Life Sciences) and Knowledge (Physical Sciences) skill checks.", "description": "You use your extensive databanks to better analyze scientific data. You can add double your Intelligence modifier to your Knowledge (Life Sciences) and Knowledge (Physical Sciences) skill checks."},
  "triage_scan": {"name": "Triage Scan", "prerequisite": "Medical Droid, Trained in Treat Injury", "benefit": "As a Standard Action, you can make a DC 20 Treat Injury check. If the check succeeds, you know if the organic characters within 6 squares and within your line of sight are below one half of their Hit Points and what step they are along the Condition Track.", "description": "As a Standard Action, you can make a DC 20 Treat Injury check. If the check succeeds, you know if the organic characters within 6 squares and within your line of sight are below one half of their Hit Points and what step they are along the Condition Track."},
  "adept_assistant": {"name": "Adept Assistant", "prerequisite": "", "benefit": "When you successfully Aid Another character on a Mechanics, Pilot, or Use Computer check, you add +5 to the check result rather than the normal +2.", "description": "When you successfully Aid Another character on a Mechanics, Pilot, or Use Computer check, you add +5 to the check result rather than the normal +2."},
  "mechanics_mastery": {"name": "Mechanics Mastery", "prerequisite": "", "benefit": "You can always Take 10 on a Mechanics check, even if distractions or hazardous circumstances would normally prevent you from doing so.", "description": "You can always Take 10 on a Mechanics check, even if distractions or hazardous circumstances would normally prevent you from doing so."},
  "vehicle_mechanic": {"name": "Vehicle Mechanic", "prerequisite": "", "benefit": "Once per day you can spend three Swift Actions in successive rounds to make a DC 20 Mechanics check to restore 1d8 Hit Points to a vehicle and move it +1 step along the Condition Track. You also restore 1 Hit Point to the vehicle for every point by which you exceed the Mechanics DC.", "description": "Once per day you can spend three Swift Actions in successive rounds to make a DC 20 Mechanics check to restore 1d8 Hit Points to a vehicle and move it +1 step along the Condition Track. You also restore 1 Hit Point to the vehicle for every point by which you exceed the Mechanics DC."},
  "burst_transfer": {"name": "Burst Transfer", "prerequisite": "", "benefit": "You can double the amount of data transferred with the Binary language in a single round when communicating with other droids with Burst Transfer, and you can Access Information in half the time when making Use Computer checks to find general or specific information.", "description": "You can double the amount of data transferred with the Binary language in a single round when communicating with other droids with Burst Transfer, and you can Access Information in half the time when making Use Computer checks to find general or specific information."},
  "on_board_system_link": {"name": "On-Board System Link", "prerequisite": "", "benefit": "While aboard a starship or vehicle and plugged into the ship's systems by Scomp Link, Droid Socket, or basic data port, you can Reroute Power or Recharge Shields as two Swift Actions instead of three.", "description": "While aboard a starship or vehicle and plugged into the ship's systems by Scomp Link, Droid Socket, or basic data port, you can Reroute Power or Recharge Shields as two Swift Actions instead of three."},
  "quick_astrogation": {"name": "Quick Astrogation", "prerequisite": "Trained in Use Computer", "benefit": "Your speedy electronic Astrogation-calculation routines allow you to cut calculation time in half. Additionally, when attempting a Use Computer check to Astrogate, you can make the calculation as a Standard Action instead of a Full-Round Action.", "description": "Your speedy electronic Astrogation-calculation routines allow you to cut calculation time in half. Additionally, when attempting a Use Computer check to Astrogate, you can make the calculation as a Standard Action instead of a Full-Round Action."},
  "scomp_link_slicer": {"name": "Scomp Link Slicer", "prerequisite": "Any two Talents from the Slicer Talent Tree; Burst Transfer can count as one of these Talents", "benefit": "Your inherent speed and advanced skill reduce the danger of slicing computer systems. You must be physically linked to the system you are slicing. You can use each of the following actions once per encounter: Eradicate, Lockout, and Untraceable.", "description": "Your inherent speed and advanced skill reduce the danger of slicing computer systems. You must be physically linked to the system you are slicing. You can use each of the following actions once per encounter: Eradicate, Lockout, and Untraceable."},
  "etiquette": {"name": "Etiquette", "prerequisite": "", "benefit": "When you succeed on a Persuasion check to change a character's Attitude, you adjust the target's Attitude by one additional step.", "description": "When you succeed on a Persuasion check to change a character's Attitude, you adjust the target's Attitude by one additional step."},
  "helpful": {"name": "Helpful", "prerequisite": "", "benefit": "Once per turn you can use the Aid Another action to assist any adjacent ally on a skill check as a Swift Action instead of a Standard Action.", "description": "Once per turn you can use the Aid Another action to assist any adjacent ally on a skill check as a Swift Action instead of a Standard Action."},
  "protocol": {"name": "Protocol", "prerequisite": "", "benefit": "You always succeed on attempts to Aid Another on Deception, Knowledge, and Persuasion checks; no roll is required.", "description": "You always succeed on attempts to Aid Another on Deception, Knowledge, and Persuasion checks; no roll is required."},
  "nuanced": {"name": "Nuanced", "prerequisite": "", "benefit": "You are skilled in the nuances of diplomatic speech and gestures. Once per encounter, you can add your Wisdom bonus to a Persuasion check in addition to your Charisma bonus.", "description": "You are skilled in the nuances of diplomatic speech and gestures. Once per encounter, you can add your Wisdom bonus to a Persuasion check in addition to your Charisma bonus."},
  "observant": {"name": "Observant", "prerequisite": "", "benefit": "You enhance your persuasiveness by applying data obtained through observation. Whenever you would fail a Persuasion check, you can roll a Perception check as a Free Action, with a DC equal to the DC of the Persuasion check. If you succeed, add +5 to the original Persuasion check result.", "description": "You enhance your persuasiveness by applying data obtained through observation. Whenever you would fail a Persuasion check, you can roll a Perception check as a Free Action, with a DC equal to the DC of the Persuasion check. If you succeed, add +5 to the original Persuasion check result."},
  "supervising_droid": {"name": "Supervising Droid", "prerequisite": "Observant, Any Talent from the Influence Talent Tree, Inspiration Talent Tree, or Leadership Talent Tree", "benefit": "You are programmed to oversee other droids. You can use each of the following actions once per encounter: Combat Support, Director, and Instant Action.", "description": "You are programmed to oversee other droids. You can use each of the following actions once per encounter: Combat Support, Director, and Instant Action."},
  "talkdroid": {"name": "Talkdroid", "prerequisite": "Trained in Persuasion", "benefit": "You know how to subtly massage translations. When one of your allies is attempting to use the Persuasion skill to change the Attitude of a creature that does not understand your ally, you add +2 to the ally's Persuasion check results if you perform the translation.", "description": "You know how to subtly massage translations. When one of your allies is attempting to use the Persuasion skill to change the Attitude of a creature that does not understand your ally, you add +2 to the ally's Persuasion check results if you perform the translation."},
  "combat_repairs": {"name": "Combat Repairs", "prerequisite": "", "benefit": "Once per day, as a Full-Round Action, you can use the Mechanics skill to repair yourself using the Repair Droid application of the skill, as opposed to the normal 1 hour.", "description": "Once per day, as a Full-Round Action, you can use the Mechanics skill to repair yourself using the Repair Droid application of the skill, as opposed to the normal 1 hour."},
  "droid_smash": {"name": "Droid Smash", "prerequisite": "", "benefit": "You can use your mechanical strength when wielding a melee weapon. You add 2 x your Strength bonus to melee damage rolls when wielding a weapon in one hand.", "description": "You can use your mechanical strength when wielding a melee weapon. You add 2 x your Strength bonus to melee damage rolls when wielding a weapon in one hand."},
  "targeting_package": {"name": "Targeting Package", "prerequisite": "", "benefit": "You can take two consecutive Swift Actions in the same round to activate special targeting software. When you do so, you gain a +2 bonus on attack rolls and damage rolls on your next attack if your target is at Point-Blank Range or within reach for melee attacks and within line of sight. The effect stacks with Point-Blank Shot.", "description": "You can take two consecutive Swift Actions in the same round to activate special targeting software. When you do so, you gain a +2 bonus on attack rolls and damage rolls on your next attack if your target is at Point-Blank Range or within reach for melee attacks and within line of sight. The effect stacks with Point-Blank Shot."},
  "just_a_scratch": {"name": "Just a Scratch", "prerequisite": "Equipped with Medium Armor or Heavy Armor, Proficient with Armor equipped", "benefit": "Once per encounter, as a Reaction, you can reduce the damage from a single attack that targets your Reflex Defense by an amount equal to your Fortitude Defense.", "description": "Once per encounter, as a Reaction, you can reduce the damage from a single attack that targets your Reflex Defense by an amount equal to your Fortitude Defense."},
  "target_acquisition": {"name": "Target Acquisition", "prerequisite": "", "benefit": "Once per encounter, as a Swift Action, designate an enemy target within line of sight as an acquired target. You gain a +1 circumstance bonus to attack rolls and damage rolls for all attacks against that target until the end of the encounter, as long as the target remains within your line of sight.", "description": "Once per encounter, as a Swift Action, designate an enemy target within line of sight as an acquired target. You gain a +1 circumstance bonus to attack rolls and damage rolls for all attacks against that target until the end of the encounter, as long as the target remains within your line of sight."},
  "target_lock": {"name": "Target Lock", "prerequisite": "Target Acquisition", "benefit": "You lock onto the target designated by the Target Acquisition talent. If the target leaves your line of sight, you automatically reacquire the Target Lock as a Reaction if the target comes back within your line of sight. You also gain a +5 bonus to your Perception skill when opposing the target's Stealth checks.", "description": "You lock onto the target designated by the Target Acquisition talent. If the target leaves your line of sight, you automatically reacquire the Target Lock as a Reaction if the target comes back within your line of sight. You also gain a +5 bonus to your Perception skill when opposing the target's Stealth checks."},
  "weapons_power_surge": {"name": "Weapons Power Surge", "prerequisite": "Equipped with a Weapon Tool", "benefit": "Once per encounter, as a Free Action, you can increase the damage dealt by one of your weapons by 1 or 2 damage dice in exchange for moving -1 step down the Condition Track for each die increased. The weapon must be permanently mounted to your chassis as a Tool and must use your internal power supply.", "description": "Once per encounter, as a Free Action, you can increase the damage dealt by one of your weapons by 1 or 2 damage dice in exchange for moving -1 step down the Condition Track for each die increased. The weapon must be permanently mounted to your chassis as a Tool and must use your internal power supply."},
  "cargo_hauler": {"name": "Cargo Hauler", "prerequisite": "", "benefit": "You gain a +5 bonus on Strength-based skill checks. Additionally, you double your carrying capacity.", "description": "You gain a +5 bonus on Strength-based skill checks. Additionally, you double your carrying capacity."},
  "environmentally_shielded": {"name": "Environmentally Shielded", "prerequisite": "", "benefit": "You gain a +5 Equipment bonus to your Fortitude Defense against environmental hazards, including atmospheric hazards and acid.", "description": "You gain a +5 Equipment bonus to your Fortitude Defense against environmental hazards, including atmospheric hazards and acid."},
  "power_supply": {"name": "Power Supply", "prerequisite": "", "benefit": "You have learned to reroute power through your system to act as a Power Generator, providing power to an E-Web Repeating Blaster or similar weapon requiring a Power Generator. Additionally, whenever you would normally spend three Swift Actions to recharge shields or reroute power on a vehicle or starship, you need spend only two Swift Actions instead.", "description": "You have learned to reroute power through your system to act as a Power Generator, providing power to an E-Web Repeating Blaster or similar weapon requiring a Power Generator. Additionally, whenever you would normally spend three Swift Actions to recharge shields or reroute power on a vehicle or starship, you need spend only two Swift Actions instead."},
  "durable": {"name": "Durable", "prerequisite": "", "benefit": "You are particularly durable and continue to function when a lesser droid would become Disabled. The first time during an encounter that you would be moved to the bottom of the Condition Track by any effect, you instead stop at the -4 step. Additionally, if a single attack causes you to move multiple steps down the Condition Track, you can spend a Force Point as a Reaction to only move -1 step down the Condition Track.", "description": "You are particularly durable and continue to function when a lesser droid would become Disabled. The first time during an encounter that you would be moved to the bottom of the Condition Track by any effect, you instead stop at the -4 step. Additionally, if a single attack causes you to move multiple steps down the Condition Track, you can spend a Force Point as a Reaction to only move -1 step down the Condition Track."},
