...
export const HOUSERULE_MANIFEST = [
...

  {
    ...
    category: 'characterCreation',
    description: 'Followers can select from available backgrounds during creation. Default on; GMs may turn this off.',
    type: 'boolean',
    choices: null,
    default: true,
    status: 'wired',
  ...
  {
    key: 'allowHumanFollowerNormalBonus',
    name: 'Allow Human Follower Normal Bonus',
    category: 'characterCreation',
    description: 'If enabled, Human followers may use normal Human bonus feat/skill behavior. Default off; otherwise Human followers choose one cross-template follower benefit instead.',
    type: 'boolean',
    choices: null,
    default: false,
    status: 'wired',
  ...
  {
    key: 'allowDroidFollowers',
    name: 'Allow Droid Followers',
    category: 'characterCreation',
    description: 'If enabled, players may create droid followers from follower-granting talents. Default on.',
    type: 'boolean',
    choices: null,
    default: true,
    status: 'wired',
  ...
  {
    key: 'allowDroidFollowerSizeChoice',
    name: 'Allow Small/Large Droid Followers',
    category: 'characterCreation',
    description: 'If enabled, droid followers may be Small or Large. Default off; otherwise Medium is enforced.',
    type: 'boolean',
    choices: null,
    default: false,
    status: 'wired',
