...
export class SWSEActorSheet extends ActorSheet {
  ...
  async _onAddEqassets/uipment(event) {
    event.preventDefault();
    await this.actor.createEmbeddedDocuments("Item", [{
