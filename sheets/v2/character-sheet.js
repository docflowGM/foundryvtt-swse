...
export class SWSEV2CharacterSheet extends
  ...
  requestRender(reason = 'unspecified', ...args) {
    ...
    if (this._isRendering) {
      console.warn(`[SWSEV2CharacterSheet] ⚠️ Render requested while already rendering — QUEUED (${reason})`);
      return this;
    }
  ...
  async render(...args) {
    ...
    if (this._isRendering) {
      ...
      console.warn("[SWSEV2CharacterSheet] ⚠️ Render called while already rendering — QUEUED (loop prevention)");
      return this;
    }
